...
<!-- <form class="customForm">
	...
	<div class="whitebox">
		<div class="adminDashboardrowCont">
			<div class="adminDashboardrow">
				...
				<div class="colm pull-right">
					...
					<div class="form-group">
						<label class="text-right fullblock">Acess</label>
		...
		<div class="form-group customBtnset align-left no-gap">
			<a href="javascript:void(0);" class="btn btn-default btn-sm">Cancel</a>
...
<?php $form = ActiveForm::begin([
    							...
    							?>
	<h2 class="secTl">Admin Profile Add</h2>
	<div class="whitebox">
		<div class="adminDashboardrowCont">
			<div class="adminDashboardrow">
				<div class="hide"></div>
